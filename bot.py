...
cities = {'а': ['Амстердам', 'Афины', 'Атланта', 'Ашхабад', 'Анкара', 'Астрахань', 'Адыгейск', 'Антверпен', 'Адлер', 'Агра', 'Александрия'],
          'б': ['Бразилия', 'Берлин', 'Барселона', 'Белград', 'Бухарест', 'Будапешт', 'Бремен', 'Бирмингем', 'Баку', 'Бишкек', 'Белгород', 'Брест'],
          'в': ['Вена', 'Волгоград', 'Варшава', 'Воронеж', 'Владимир', 'Вильнюс', 'Валенсия', 'Венеция', 'Вашингтон', 'Владивосток', 'Верона'],
          'г': ['Гомель', 'Грозный', 'Гамбург', 'Гуанчжоу', 'Генуя', 'Гент', 'Гданьск', 'Гавана', 'Глазго', 'Ганновер', 'Гвадалахара', 'Гаага'],
          'д': ['Дели', 'Дмитров', 'Детройт', 'Дубай', 'Долгопрудный', 'Дюссельдорф', 'Дрезден', 'Дортмунд', 'Денвер', 'Даллас', 'Дублин', 'Джакарта'],
          ...
          'к': ['Казань', 'Кёльн', 'Киев', 'Киров', 'Копенгаген', 'Краков', 'Краснодар', 'Кишинёв', 'Коломна', 'Курск', 'Калуга', 'Красновярск', 'Кострома', 'Калининград', 'Кейптаун'],
          'л': ['Львов', 'Лейпциг', 'Лидс', 'Липецк', 'Лиссабон', 'Лондон', 'Лодзь', 'Лос-Анджелес', 'Ливерпуль', 'Лион', 'Ломе', 'Лас-Вегас', 'Лима'],
          'м': ['Мадрид', 'Минск', 'Милан', 'Москва', 'Мюнхен', 'Малага', 'Марсель', 'Махачкала', 'Магадан', 'Муром', 'Мурманск', 'Манчестер', 'Марсель'],
          'н': ['Нью-Йорк', 'Неаполь', 'Набережные Челны', 'Нюрнберг', 'Нижний Новгород', 'Новосибирск', 'Норильск', 'Ницца', 'Нальчик', 'Ниш', 'Новочеркасск', 'Ним'],
          'о': ['Осло', 'Одесса', 'Орёл', 'Омск', 'Ош', 'Оренбург', 'Осака', 'Орландо', 'Орлеан', 'Остин', 'Оттава', 'Оденсе', 'Остенде'],
          'п': ['Париж', 'Прага', 'Пенза', 'Пушкин', 'Пермь', 'Подольск', 'Пекин', 'Пятигорск', 'Псклов', 'Полоцк', 'Пиза', 'Палермо', 'Познань'],
          'р': ['Рим', 'Ростов-на-Дону', 'Рязань', 'Рига', 'Рыбинск', 'Рио-де-Жанейро', 'Родос', 'Роттердам', 'Рейкьявик', 'Реймс', 'Ренн'],
          'с': ['Сочи', 'Санкт-Петербург', 'Смоленск', 'Саратов', 'Самара', 'Саранск', 'Стамбул', 'Сергиев Посад', 'Сусс', 'Сеул', 'София', 'Суздаль', 'Севилья'],
          'т': ['Тбилиси', 'Тольятти', 'Тирана', 'Турин', 'Тула', 'Тверь', 'Токио', 'Ташкент', 'Тамбов', 'Тюмень', 'Таганрог', 'Таллин', 'Торонто', 'Тулуза'],
          'у': ['Уфа', 'Ульяновск', 'Углич', 'Ухта', 'Улан-Удэ', 'Улан-Батор', 'Ухань', 'Утрехт', 'Урбино', 'Уссурийск'],
          'ф': ['Флоренция', 'Франкферт-на-Майне', 'Фамагуста', 'Фергана', 'Фетхие', 'Форос', 'Фивы', 'Филадельфия', 'Фатима'],
          'х': ['Хельсинки', 'Харьков', 'Ханой', 'Хаммамет', 'Херсон', 'Хайфа', 'Худжанд', 'Ханты-Мансийск', 'Харбин', 'Хиросима', 'Хьюстон'],
